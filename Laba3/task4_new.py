import sys
from london_underground import *
...
def dijkstra_algorithm(graph, start_node):  # graph - экземпляр класа Graph
...
previous_nodes, shortest_path = dijkstra_algorithm(graph=graph, start_node="Great Portland Street")
print_result(previous_nodes, shortest_path, start_node="Great Portland Street", target_node="Chancery Lane")
